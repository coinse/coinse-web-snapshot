...
function sally() {
  ...
  // smile
  var lip = new Zdog.Ellipse({
    addTo: head,
    diameter: 1.1,
    quarters: 2,
    translate: { x: 0.5, y: 1, z: 4.5 },
    stroke: 1.1,
    //fill: true,
    color: '#ff8c00',
  });
  ...
  lip.copy({
    translate: { x: -0.75, y: 1, z: 4.5 },
  });
  lip.copy({
    translate: { x: -0.25, y: 1, z: 4.5 },
  });
  lip.copy({
    translate: { x: 0.25, y: 1, z: 4.5 },
  });
